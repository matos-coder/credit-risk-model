...
# Task 4: Proxy Target Variable Engineering (src/target_engineering.py)
#
# This script creates the proxy target variable ('is_high_risk') by
# identifying disengaged customers using RFM analysis and K-Means clustering.
# ==============================================================================
