...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Error: The data file was not found. Please ensure 'Xente_Train.csv' is in the '../data/raw/' directory.")
        exit()
    ...
    # Note on WoE and IV:
    # Libraries like 'xverse' and 'woe' are excellent for creating Weight of Evidence (WoE) features.
    # WoE is particularly powerful for building interpretable scorecard models with Logistic Regression.
    # For this general-purpose pipeline, which can feed into any type of model (like Gradient Boosting),
    # One-Hot Encoding is a more standard and flexible approach. A WoE transformation would typically
    # be part of a separate, more specialized pipeline tailored for a Logistic Regression model.
