...
# Task 5: Model Training and Tracking (src/train.py)
#
# This script orchestrates the full model training pipeline:
# 1. Loads raw data.
# 2. Creates the target variable.
# 3. Applies the feature engineering pipeline.
